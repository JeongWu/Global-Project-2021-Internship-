...
var MembersListDatatable = function() {
	var memberObjectArray = new Array();
	...
	var _showTable = function() {
		var datatable = $('#kt_datatable').KTDatatable({
			...
			columns: [
				...
				},
				{
					...
					title: '%',
					template: function(data) {
						return '<span class="font-weight-bolder text-dark">78%</span>';
					},
				},
		...
		datatable.on('click', '[data-record-id]', function() {
			...
			console.log(memberObjectArray[id]);

			$('#edit-name-input').val(memberObjectArray[id].name),
			$('#edit-member-id-input').val(memberObjectArray[id].userId),
			$('#edit-email-input').val(memberObjectArray[id].email),
			$('#edit-team-id-select').val(memberObjectArray[id].team.id),
			$('#edit-level-select').val(memberObjectArray[id].level),
		    ...
		    .on('core.form.valid', function() {
		        ...
		        FormValidation.utils.fetch('/member/edit', {
		            ...
		            params: { 
						...
						teamId: $('#edit-team-id-select').val(),
