  ...
  var _demo = function () {
    var datatable = $("#kt_datatable").KTDatatable({
      ...
      data: {
        ...
        source: {
          read: {
            url:"/api/datatables/team-member"
          },
        },
      ...
      columns: [
        {
          ...
          template: function (data) {
            return (
              '<span class="font-weight-bolder">' + data.team2.teamSeq + "</span>"
            );
          },
        },
        {
        ...
        },
        {
          ...
          template: function (data) {
            ...
            var statusNo=1;
            if(data.team2.teamType==="SQUAD")
            statusNo=2;
            else if(data.team2.teamType==="TFT")
            statusNo=3;
            ...
            template: function(data) {
                ...
                if (number > 8) {
                    ...
                    <div class="symbol symbol-40 symbol-circle symbol-light-' +state+' flex-shrink-0">\
                            <span class="symbol-label font-size-h4">' + data.member2.name.substring(0, 1) + '</span>\
                        </div>\
                                    </div>';
                }
        ...
        },
        {
          ...
          template: function (data) {
            ...
            var statusNo=data.team2.useFlag==='Y'?1:2;
            return (
