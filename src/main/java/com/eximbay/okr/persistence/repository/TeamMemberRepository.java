...
import com.eximbay.okr.persistence.entity.TeamMember;
import com.eximbay.okr.persistence.entity.TeamMemberId;
...
public interface TeamMemberRepository extends JpaRepository<TeamMember,Integer>{
   ...
   // @Query(value = "SELECT o.id, o.obj_no, o.obj_name, o.level, o.year, o.quarter, o.status, o.reg_user_id, o.reg_dt, o.mod_user_id, o.mod_dt, o.member_id, "
    ...
    //         + "WHERE o.level = :level and o.quarter = :quarter and o.year = :ye ar and m.team_id = :team_id "
    ...
    @Query(value = "SELECT t.team_seq, t.name, t.team_type, t.use_flag,tm.member_seq,m.name,t.division_seq "
            + "FROM team_member tm "
            + "left outer join team2 t on t.team_seq = tm.team_seq "
